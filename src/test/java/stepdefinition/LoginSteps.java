...
public void validation_messages_and_should_be_displayed(String string, String string2) {
...
public void user_unchecks_the_option_after_entering_password(String string) {
